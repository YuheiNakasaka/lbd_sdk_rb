  ...
  describe '#flatten' do
    ...
    context 'when request body is a normal hash' do
      it 'should return a parsed string' do
        ...
        expected =
          'name=NewName&ownerAddress=tlink1fr9mpexk5yq3hu6jc0npajfsa0x7tl427fuveq&ownerSecret=uhbdnNvIqQFnnIFDDG8EuVxtqkwsLtDR/owKInQIYmo=' # rubocop:disable Layout/LineLength
        expect(instance.flatten(input)).to eq(expected)
      end
    end
